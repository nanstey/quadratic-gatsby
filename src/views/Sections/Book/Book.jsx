    ...
    <PageSection className={className} id={anchor}>
      ...
      <Row>
        <div id="CHECKFRONT_WIDGET">
          <p id="CHECKFRONT_LOADER" style={{ background: "url('//test.checkfront.com/images/loader.gif') left center no-repeat", padding: "5px 5px 5px 20px" }}>
            Searching Availability...
          </p>
        </div>
        <noscript><a href="https://test.checkfront.com/reserve/" style={{ fontSize: "16" }}>Continue to Secure Booking System &raquo;</a></noscript>
      </Row>
    </PageSection >
  );
};
